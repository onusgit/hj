                ...
                <div class="container padding-0">
                    ...
                    <div id="products" class="row margin-0 list-group padding-top-4per">
                        ...
                        if (isset($_GET['car_category'])):
                            $in_category = $_GET['car_category'];
                        endif;

                        if (isset($_GET['car_sub_category'])):
                            $in_category = $_GET['car_sub_category'];
                        endif;

                        if (isset($_GET['car_year'])):
                            $in_category = $_GET['car_year'];
                        endif;
...
//                            'meta_value' => '559581d9067ad59e',
//                            'meta_query' => array(
//                                'relation' => 'AND',
//                                array(
//                                    'key' => 'cp_sys_ad_conf_id',
//                                    'value' => !isset($_GET['adsnumber']) ? $_GET['adsnumber'] : '',
//                                    'compare' => 'IN'
//                                )
//                            ),
                            'ad_tag' => $_GET['ad_tags'],
...
//                                    'taxonomy' => 'ad_cat',
//                                    'field' => 'term_id',
//                                    'terms' => !isset($in_category) ? $in_category : '',
//                                    'operator' => 'IN'
//                                )
//                            )
                        );
                        ...
                        if (isset($_GET['adsnumber']) && !empty($_GET['adsnumber'])):
                            $q = array('meta_query' => array(
                                    'relation' => 'AND',
                                    array(
                                        'key' => 'cp_sys_ad_conf_id',
                                        'value' => $_GET['adsnumber'],
                                        'compare' => 'IN'
                                    )
                                )
                            );
                        ...
                        if (isset($in_category) && !empty($in_category)):
    ...
    <div class="col-xs-12  col-sm-3 col-md-3 col-lg-3 round-border bg-grey">
        ...
        <div class="side-col  ">
            <form class="form-horizontal  bs-example-control-sizing" name="drop_list" method="get" action="">                <?php
                $all_category = get_terms('ad_cat', array('hide_empty' => false, 'parent' => 13));
                ?>
                ...
                <select name="car_sub_category" class="form-control margin-top-10" disabled id="sub_category_select"></select>

                <select name="car_year" class="form-control margin-top-10" disabled id="year_select"></select>
    ...
    $(document).ready(function () {
        ...
        $('#parent_cat').on('change', function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                data: 'action=get_car_sub_category_select&parent_cat_ID=' + parentCat,
                success: function (results)
                {
                    $("#sub_category_select").replaceWith(results);
                }
            });
        });
        ...
        $(document).on('change', '#sub_category_select', function () {
            ...
            $.ajax({
                url: "<?php echo admin_url('admin-ajax.php') ?>",
                type: 'POST',
                data: 'action=get_car_year_select&sub_cat_id=' + parentCat,
                success: function (results)
                {
                    $("#year_select").replaceWith(results);
                }
            });
        });
