...
function _appthemes_register_scripts() {
	...
	wp_register_style( 'jquery-ui-style', APP_FRAMEWORK_URI . '/styles/jquery-ui/jquery-ui.css', false, '1.13.0' );

	wp_register_script( 'colorbox', APP_FRAMEWORK_URI . '/js/colorbox/jquery.colorbox.min.js', array( 'jquery' ), '1.5.13' );
	wp_register_style( 'colorbox', APP_FRAMEWORK_URI . '/js/colorbox/colorbox.css', false, '1.5.13' );
	...
	wp_register_script( 'footable', APP_FRAMEWORK_URI . '/js/footable/jquery.footable.min.js', array( 'jquery' ), '2.0.1.5' );
	wp_register_script( 'footable-sort', APP_FRAMEWORK_URI . '/js/footable/jquery.footable.sort.min.js', array( 'footable' ), '2.0.1.5' );
	wp_register_script( 'footable-filter', APP_FRAMEWORK_URI . '/js/footable/jquery.footable.filter.min.js', array( 'footable' ), '2.0.1.5' );
	wp_register_script( 'footable-paginate', APP_FRAMEWORK_URI . '/js/footable/jquery.footable.paginate.min.js', array( 'footable' ), '2.0.1.5' );
