...
<div class="content_right">
    ...
    <div class="shadowblock_out">
        ...
        <div class="shadowblock">
            ...
            <h2 class="dotted"><?php _e('خيارات المستخدم', APP_TD); ?></h2>

            <div class="recordfromblog">

                <?php if (has_nav_menu('theme_dashboard')) : wp_nav_menu(array('theme_location' => 'theme_dashboard', 'menu_id' => 'menu-dashboard', 'container' => false));
                else : ?>

                    <ul>
                        <li><a href="<?php echo CP_DASHBOARD_URL; ?>"><?php _e('لوحة التحكم', APP_TD); ?></a></li>
                        <li><a href="<?php echo CP_PROFILE_URL; ?>"><?php _e('تعديل الملف الشخصي', APP_TD); ?></a></li>
                        <?php if (current_user_can('edit_others_posts')) { ?><li><a href="<?php echo admin_url(); ?>"><?php _e('WordPress Admin', APP_TD); ?></a></li><?php } ?>
                        <li><a href="<?php echo $logout_url; ?>"><?php _e('خروج', APP_TD); ?></a></li>
                    </ul>
    ...
    <div class="shadowblock_out">
        ...
        <div class="shadowblock">
            ...
            <h2 class="dotted"><?php _e('معلومات الحساب', APP_TD); ?></h2>
            ...
            <ul class="user-info">
                ...
                <li><strong><?php _e('عضو منذ:', APP_TD); ?></strong> <?php echo appthemes_display_date($current_user->user_registered, 'datetime', true); ?></li>
                <li><strong><?php _e('آخر تسجيل دخول:', APP_TD); ?></strong> <?php echo appthemes_get_last_login($current_user->ID); ?></li>
            </ul>
    ...
    <div class="shadowblock_out">
        ...
        <div class="shadowblock">
            ...
            <h2 class="dotted"><?php _e('إحصائيات الحساب', APP_TD); ?></h2>
...
// calculate the total count of live ads for current user
	...
	GROUP BY post_status", $current_user->ID
                ...
                <li><?php _e('اعلانات فعالة:', APP_TD); ?> <strong><?php echo $post_count_live; ?></strong></li>
                <li><?php _e('إعلانات في الانتظار:', APP_TD); ?> <strong><?php echo $post_count_pending; ?></strong></li>
                <li><?php _e('اعلانات منتهية', APP_TD); ?> <strong><?php echo $post_count_offline; ?></strong></li>
                <li><?php _e('مجموع الاعلانات', APP_TD); ?> <strong><?php echo $post_count_total; ?></strong></li>
