...
class CP_Membership_Package_General_Metabox extends APP_Meta_Box {
	...
	public function form_fields() {
		$form_fields = array(
			...
			array(
				'title' => __( 'Price Modifier (How a membership affects the price of an ad)', APP_TD ),
				'type' => 'text',
				'name' => 'price_modifier',
				'desc' => '<br />' . __( 'Enter #.## for currency (i.e. 2.25 for $2.25), ### for percentage (i.e. 50 for 50%)' , APP_TD ),
			...
			array(
				'title' => __( 'Satisfies Membership Requirement', APP_TD ),
				'type' => 'checkbox',
