 ...
 */
class CP_Listing_Attachments_Metabox extends APP_Post_Attachments_Metabox {

	public function __construct() {
		parent::__construct( 'listing-attachments', __( 'Listing Attachments', APP_TD ), APP_POST_TYPE );
	}
